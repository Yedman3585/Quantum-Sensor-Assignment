...
#
#
# def load_quantum_runs():
#     files = sorted(glob.glob("logs_openjij_windows/progress_*.jsonl"))
#     runs = {}
#     for file in files:
...
#
#
# quantum_runs_data = load_quantum_runs()
#
# app.layout = html.Div([
#     html.H1("Quantum Annealing Scheduler — Professional Dashboard",
#             style={'textAlign': 'center', 'color': '#7b1fa2'}),
#
#     dcc.Tabs(id="tabs", value='tab-coverage', children=[
#         dcc.Tab(label='Coverage & Comparison', value='tab-coverage'),
#         dcc.Tab(label='SQA Success Rate', value='tab-success'),
#         dcc.Tab(label='Quantum Energy Evolution', value='tab-energy'),
#         dcc.Tab(label='3D Quantum Tunneling', value='tab-3d'),
#     ]),
...
#     if not quantum_runs_data:
#         return html.Div("No quantum logs found in 'logs_openjij_windows/' folder.",
#                         style={'color': 'red', 'textAlign': 'center', 'padding': '20px'})
#
#     if tab == 'tab-coverage':
#         fig = go.Figure()
#         for run_id, df in quantum_runs_data.items():
#             fig.add_trace(go.Scatter(
#                 x=df['batch_idx'], y=df['coverage_percent'],
#                 mode='lines+markers',
#                 name=f'Quantum Annealing {run_id}',
#                 line=dict(width=3, color='#7b1fa2')
#             ))
#
#             try:
#                 with open("quantum_openjij_windows.log", "r", encoding="utf-8") as f:
#                     log_text = f.read()
#                 import re
#                 match = re.search(rf"Coverage: (\d+)/20000", log_text)
#                 if match:
...
#
#         fig.update_layout(
#             title="Camera Coverage: Quantum Annealing vs Greedy Baseline",
...
#         fig = go.Figure()
#         colors = ['#7b1fa2', '#ba68c8', '#9c27b0', '#6a1b9a']
#         for idx, (run_id, df) in enumerate(quantum_runs_data.items()):
#             fig.add_trace(go.Scatter(
#                 x=df['batch_idx'],
...
#
#         fig.update_layout(
#             title="Simulated Quantum Annealing (SQA) Success Rate",
#             xaxis_title="Batch Index",
...
#
#         fig.update_layout(
#             title="Quantum Annealing Energy Evolution (Lower is Better)",
#             xaxis_title="Batch Index",
#             yaxis_title="Energy",
#             template='plotly_white',
#             height=500
...
#     elif tab == 'tab-3d':
#         fig = go.Figure()
#         colors = ['#7b1fa2', '#ba68c8', '#9c27b0', '#6a1b9a', '#4a148c']
#         all_x, all_y, all_z = [], [], []
#
#         for idx, (run_id, df) in enumerate(quantum_runs_data.items()):
#             energy = df['energy'].dropna()
...
#                     zaxis_title="Energy"
#                 ),
#                 title="3D Quantum Annealing Energy Landscape"
#             )
#             return dcc.Graph(figure=fig)
#
...
#             print(f"[3D] Quantum surface generation failed: {e}")
#
#         try:
...
#
#         fig.update_layout(
#             title="3D Quantum Annealing: Energy Landscape with Tunneling",
#             scene=dict(
#                 xaxis_title="Batch Index",
#                 yaxis_title="Coverage %",
#                 zaxis_title="Energy",
...
#     print("Starting Quantum Annealing Dashboard...")
#     print("Open: http://127.0.0.1:8051")
#     print("Make sure 'logs_openjij_windows/progress_*.jsonl' files exist")
